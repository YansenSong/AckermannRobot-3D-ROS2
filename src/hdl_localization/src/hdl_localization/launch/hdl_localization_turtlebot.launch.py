...
def generate_launch_description():
    ...
    imu_topic = LaunchConfiguration('imu_topic', default='/gpsimu_driver/imu_data')
    globalmap_pcd = DeclareLaunchArgument('globalmap_pcd', default_value='/home/qulingjun/hdl_ws_ros2/src/hdl_localization/data/map.pcd', description='Path to the global map PCD file')
    ...
    invert_imu_acc = LaunchConfiguration('invert_imu_acc', default='true')
    invert_imu_gyro = LaunchConfiguration('invert_imu_gyro', default='true')
