...
class LpCURS3Proxy: public rclcpp::Node
{
public:
    ...
    void run(void)
    {
        updateTimer = this->create_wall_timer(
            ...
            std::bind(&LpCURS3Proxy::update, this));
    }
...
int main(int argc, char *argv[])
{
    ...
    auto lpCURS3 = std::make_shared<LpCURS3Proxy>();
    lpCURS3->run();
    rclcpp::spin(lpCURS3);
    rclcpp::shutdown();
    return 0;
