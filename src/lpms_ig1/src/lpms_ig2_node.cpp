...
public:
        ...
        : Node("lpms_ig2_node")
    {
        ...
        autocalibration_serv = this->create_service<std_srvs::srv::SetBool>(
                "enable_gyro_autocalibration",std::bind(&LpIG2Proxy::setAutocalibration, this,std::placeholders::_1, std::placeholders::_2));
        autoReconnect_serv = this->create_service<std_srvs::srv::SetBool>(
                "enable_auto_reconnect",std::bind(&LpIG2Proxy::setAutoReconnect, this, std::placeholders::_1, std::placeholders::_2));
        gyrocalibration_serv = this->create_service<std_srvs::srv::Trigger>(
                "calibrate_gyroscope",std::bind(&LpIG2Proxy::calibrateGyroscope, this, std::placeholders::_1, std::placeholders::_2));
        resetHeading_serv = this->create_service<std_srvs::srv::Trigger>(
                "reset_heading",std::bind(&LpIG2Proxy::resetHeading, this, std::placeholders::_1, std::placeholders::_2));
        getImuData_serv = this->create_service<std_srvs::srv::Trigger>(
                "get_imu_data",std::bind(&LpIG2Proxy::getImuData, this, std::placeholders::_1, std::placeholders::_2));
        setStreamingMode_serv = this->create_service<std_srvs::srv::Trigger>(
                "set_streaming_mode",std::bind(&LpIG2Proxy::setStreamingMode, this, std::placeholders::_1, std::placeholders::_2));
        setCommandMode_serv = this->create_service<std_srvs::srv::Trigger>(
                "set_command_mode",std::bind(&LpIG2Proxy::setCommandMode, this, std::placeholders::_1, std::placeholders::_2));
