...
public:
        ...
        : Node("lpms_si1_node")
    {
        ...
        autocalibration_serv = this->create_service<std_srvs::srv::SetBool>(
                "imu/enable_gyro_autocalibration",std::bind(&LpSI1Proxy::setAutocalibration, this,std::placeholders::_1, std::placeholders::_2));
        autoReconnect_serv = this->create_service<std_srvs::srv::SetBool>(
                "imu/enable_auto_reconnect",std::bind(&LpSI1Proxy::setAutoReconnect, this, std::placeholders::_1, std::placeholders::_2));
        gyrocalibration_serv = this->create_service<std_srvs::srv::Trigger>(
                "imu/calibrate_gyroscope",std::bind(&LpSI1Proxy::calibrateGyroscope, this, std::placeholders::_1, std::placeholders::_2));
        resetHeading_serv = this->create_service<std_srvs::srv::Trigger>(
                "imu/reset_heading",std::bind(&LpSI1Proxy::resetHeading, this, std::placeholders::_1, std::placeholders::_2));
        getImuData_serv = this->create_service<std_srvs::srv::Trigger>(
                "imu/get_imu_data",std::bind(&LpSI1Proxy::getImuData, this, std::placeholders::_1, std::placeholders::_2));
        setStreamingMode_serv = this->create_service<std_srvs::srv::Trigger>(
                "imu/set_streaming_mode",std::bind(&LpSI1Proxy::setStreamingMode, this, std::placeholders::_1, std::placeholders::_2));
        setCommandMode_serv = this->create_service<std_srvs::srv::Trigger>(
                "imu/set_command_mode",std::bind(&LpSI1Proxy::setCommandMode, this, std::placeholders::_1, std::placeholders::_2));
