...
class LpIG2Proxy: public rclcpp::Node
{
public:
        ...
        : Node("lpms_ig2_node")
    {
        ...
        autocalibration_serv = this->create_service<std_srvs::srv::SetBool>(
                "imu/enable_gyro_autocalibration",std::bind(&LpIG2Proxy::setAutocalibration, this,std::placeholders::_1, std::placeholders::_2));
        autoReconnect_serv = this->create_service<std_srvs::srv::SetBool>(
                "imu/enable_auto_reconnect",std::bind(&LpIG2Proxy::setAutoReconnect, this, std::placeholders::_1, std::placeholders::_2));
        gyrocalibration_serv = this->create_service<std_srvs::srv::Trigger>(
                "imu/calibrate_gyroscope",std::bind(&LpIG2Proxy::calibrateGyroscope, this, std::placeholders::_1, std::placeholders::_2));
        resetHeading_serv = this->create_service<std_srvs::srv::Trigger>(
                "imu/reset_heading",std::bind(&LpIG2Proxy::resetHeading, this, std::placeholders::_1, std::placeholders::_2));
        getImuData_serv = this->create_service<std_srvs::srv::Trigger>(
                "imu/get_imu_data",std::bind(&LpIG2Proxy::getImuData, this, std::placeholders::_1, std::placeholders::_2));
        setStreamingMode_serv = this->create_service<std_srvs::srv::Trigger>(
                "imu/set_streaming_mode",std::bind(&LpIG2Proxy::setStreamingMode, this, std::placeholders::_1, std::placeholders::_2));
        setCommandMode_serv = this->create_service<std_srvs::srv::Trigger>(
                "imu/set_command_mode",std::bind(&LpIG2Proxy::setCommandMode, this, std::placeholders::_1, std::placeholders::_2));
    ...
    void run(void)
    {
        updateTimer = this->create_wall_timer(
            ...
            std::bind(&LpIG2Proxy::update, this));
    }
...
int main(int argc, char *argv[])
{
    ...
    auto lpIG2 = std::make_shared<LpIG2Proxy>();
    lpIG2->run();
    rclcpp::spin(lpIG2);
    rclcpp::shutdown();
    return 0;
